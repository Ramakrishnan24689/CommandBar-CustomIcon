...
import { renderCustomIcon } from './CustomSVGIcon';
import { renderCustomUnicodeIcon } from './CustomUnicodeIcon';
...
export function getCommandBarItemProps(
    ...
    const props = {
        ...
        ...(item.iconName && {
            onRenderIcon: () =>
                renderCustomIcon({ iconName: item.iconName ?? 'star', iconColor: item.iconColor || 'currentColor' }),
            // renderCustomUnicodeIcon({
